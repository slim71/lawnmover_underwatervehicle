...
areaOfInterestCorner = [42.317744;
                        10.915136;0]; % Lat/Lon [decimal degrees]
...
initPoint = [42.317984; 10.916219; 0];           % Lat/Lon [decimal degrees], depth [m]
           
surveyAreaCorner = [42.318165; 10.915941];     % Lat/Lon [decimal degrees]
                
firstSideLength = 15;%45;               % [m]
alpha = 30;                         % [deg]
secondSideLength = 10;%25;              % [m]
